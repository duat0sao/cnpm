         ...
         <div class="row">
            <div class="col-md-12">
                    <div class="page-header" >
                       <strong> <h2 class="text-primary fw-bold">
                       <?php
...
$query=mysqli_query($conn,"select * from hoadon where idkhach='$idkhach'");
...
?>
                        <tr>
                                ...
                                <?php $query5=mysqli_query($conn,"select * from giodo where idkhach='$idkhach'");
                                        while($row5=mysqli_fetch_array($query5)){ ?>

                                <tr>
                                    <td><?php $idsanpham= $row5['idsanpham']; 
                                    $query6=mysqli_query($conn,"select * from sanpham where idsanpham='$idsanpham'"); 
                                    $row6=mysqli_fetch_array($query6);
                                    echo $row6['tensanpham'];
                                    ?></td>
