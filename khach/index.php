	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a href="myaccount.php?idkhach=<?php $idkhach=$_GET['idkhach']; echo $idkhach;  ?>"><span class="icon-user"></span> My Account</a> 
				<a href="giaodiendangky.php"><span class="icon-edit"></span> Đăng ký  </a> 
...
<div class="row">
	<div class="span4">
	<h1>
	<a class="logo" href="index.php?idkhach=<?php echo $idkhach;  ?>"><span>NamDinhTeamPlus</span>                               
...
<div class="well well-small">
	<ul class="nav nav-list">
		...
		<li> <a class="totalInCart" href="myaccount.php"><strong>Giỏ đồ<span class="badge badge-warning pull-right" style="line-height:18px;">Đang cập nhập</span></strong></a></li>
	</ul>
</div>
	...
	<div class="well np">
		<div id="myCarousel" class="carousel slide">
            <div class="carousel-inner">
			  ...
			  <div class="item">
                <img  src="../assets/img/jne2.jpg" alt="">
              ...
              <div class="item">
                <img  src="../assets/img/jun.jpg" alt="">
...
?>
			...
			<li>
			  <div style="width:128px" style="height:128p">
				<a class="zoomTool" href="chitiet.php?idsanpham=<?php echo $row['idsanpham']; ?>&idkhach=<?php echo $idkhach; ?>" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<a href="chitiet.php?idsanpham=<?php echo $row['idsanpham']; ?>&idkhach=<?php echo $idkhach; ?>"><img style="width:128px" style="height:128p" src="../admin/photo/<?php echo $row['anhsanpham']; ?>" alt="" ></a>
				<div style="width:128px" style="height:128p" >
					<p><?php echo $row['tensanpham']; ?></p>
					<p><strong><?php echo $row['giasanpham']; ?> Vnđ </strong></p>
					<h4><a class="shopBtn" href="giodo.php?idsanpham=<?php echo $row['idsanpham']; ?>&idkhach=<?php echo $idkhach; ?>" title="add to cart"> Add to cart </a></h4>
				</div>
			  </div>
			</li>	
