...
$query=mysqli_query($conn,"select * from `sanpham` where idsanpham='$idsanpham'");
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <button type="button" class="btn btn-light btn-md mr-1 mb-2"><i
          class="fas fa-shopping-cart pr-2"></i><a href="giodo.php?idkhach=<?php echo $idkhach; ?>&idsanpham=<?php echo $idsanpham; ?>">Thêm vào giỏ đồ</a></button>
		  <a href="homthu.php" class="btn btn-light btn-md mr-1 mb-2">Tôi cần tư vấn thêm</a>
		  
		  <a href="index.php?idkhach=<?php echo $idkhach;  ?>" class="btn btn-light btn-md mr-1 mb-2">Hủy</a>
    </div>
  </div>
