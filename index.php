	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a href="giodo.php"><span class="icon-shopping-cart"></span><span class="badge badge-warning"> Đang cập nhập</span></a>
			</div>
		</div>
	</div>
</div>
...
?>
			...
			<li>
			  <div style="width:128px" style="height:128p">
				<a class="zoomTool" href="chitietsanpham.php?id=<?php echo $row['idsanpham']; ?>" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<a href="chitietsanpham.php?id=<?php echo $row['idsanpham']; ?>"><img style="width:128px" style="height:128p" src="admin/photo/<?php echo $row['anhsanpham']; ?>" alt="" ></a>
				<div style="width:128px" style="height:128p" >
